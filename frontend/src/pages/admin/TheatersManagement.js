    ...
    <Flex minH="100vh" bg="#181a20" color="white">
      ...
      <Box flex="1" p={6}>
        ...
        <Modal isOpen={isDetailOpen} onClose={onDetailClose} size="3xl">
          <ModalOverlay />
          <ModalContent bg="#1a1e29" color="white" maxH="90vh">
            <ModalHeader borderBottom="1px solid #2d3748">
              Chi tiết rạp: {selectedTheater?.name}
            </ModalHeader>
            <ModalCloseButton />
            <ModalBody pb={6} overflowY="auto">
              {loadingRooms ? (
                ...
                <VStack spacing={6} align="stretch">
                  ...
                  <Box>
                    ...
                    <SimpleGrid columns={2} spacing={4}>
                      <Box bg="gray.800" p={4} borderRadius="md">
                        ...
                        <Text fontWeight="bold">{selectedTheater?.name}</Text>
                      </Box>
                      <Box bg="gray.800" p={4} borderRadius="md">
                        <Text fontSize="xs" color="gray.400" mb={1}>
                          Địa điểm
                        </Text>
                        <Text fontWeight="bold">{selectedTheater?.location}</Text>
                      </Box>
                      <Box bg="gray.800" p={4} borderRadius="md">
                        <Text fontSize="xs" color="gray.400" mb={1}>
                          Số phòng
                      ...
                      <Box bg="gray.800" p={4} borderRadius="md">
                        ...
                        <Badge
                          colorScheme={selectedTheater?.status === "active" ? "green" : "red"}
                          fontSize="sm"
                          px={3}
                          py={1}
                        >
                          {selectedTheater?.status === "active" ? "HOẠT ĐỘNG" : "KHÔNG HOẠT ĐỘNG"}
                        </Badge>
                      </Box>
                    </SimpleGrid>
                  </Box>
                  ...
                  <Box>
                    <Heading size="sm" color="orange.400" mb={3}>
                      Danh sách phòng ({theaterRooms.length})
                    </Heading>
                        ...
                        <Table variant="simple" size="sm">
                          <Thead bg="#222633">
                            <Tr>
                              ...
                              <Th color="orange.300" isNumeric>Số ghế</Th>
                              <Th color="orange.300">Trạng thái</Th>
                          ...
                          <Tbody>
                            {theaterRooms.map((room) => (
                              <Tr key={room._id} _hover={{ bg: "#252a38" }}>
                                ...
                                <Td>
                                  <Badge
                                    colorScheme={room.status === "active" ? "green" : "red"}
                                    fontSize="xs"
                                  >
